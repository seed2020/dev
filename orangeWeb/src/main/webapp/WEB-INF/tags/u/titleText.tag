...
%><%@ attribute name="noLi"  required="false" type="java.lang.Boolean"
...
if(SecuUtil.hasAuth(request, auth, ownerUid)){
	...
	if(!Boolean.TRUE.equals(noLi))
	{
		...
		if(titleButtonType==null){
			out.println("\r\n			<li class=\"txt\">");	// li btn 테그 - open
			request.setAttribute("titleSubType", "txt");
		} else if(!"txt".equals(titleButtonType)){
