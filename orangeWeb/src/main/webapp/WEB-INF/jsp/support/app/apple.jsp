...
<!--section S-->
	...
	<div class="btnarea">
		<div class="btn" onclick="pushDown();" style="padding-top:24px;"><a href="itms-services://?action=download-manifest&url=https://gw.enobiz.com/support/app/${ptPushAppDVo.custCd}/OrangeNoti.plist" style="color:white; font-weight:bold;">DOWNLOAD for iPhone</a></div>
	</div>
	...
	<div class="listarea">
		<article>
			...
			<div class="list" id="pushInfoList">
				<dl>
				<dd class="etr_tit">${ptPushAppDVo.custNm} 애플 앱 설치</dd>
				<dd class="etr_bodytit">위 링크를 클릭해서 "${ptPushAppDVo.dispNm}"을 설치 하세요.</dd>
				<dd class="etr_bodytit">위 링크는 ${ptPushAppDVo.endYmd} 일 까지 유효 합니다.</dd>
				<dd class="etr_bodytit">애플 단말기만 설치 가능 합니다.</dd>
				<dd class="etr_bodytit">설치 후  앱을 신뢰 처리하여야 실행 됩니다.</dd>
				</dl>
			</div>
			</div>
		</article>
