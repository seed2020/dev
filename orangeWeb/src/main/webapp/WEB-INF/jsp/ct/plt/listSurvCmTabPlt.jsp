...
function fnTabClick(tId){
	getIframeContent('ctSurvTabArea').reload('./listSurvCmTabFrm.do?tId='+tId+'&${paramsForList}&hghtPx=${param.hghtPx-tabHght-15}');
};
...
<%-- <c:if test="${tabHght > 0 }">
 ...
 --%>
<iframe id="ctSurvTabArea" name="ctSurvTabArea" src="./listSurvCmTabFrm.do?tId=${tId }&${paramsForList }&hghtPx=${param.hghtPx-tabHght-15}" style="width:100%;height:${param.hghtPx-tabHght-15}px;" frameborder="0" marginheight="0" marginwidth="0"></iframe>
</div>