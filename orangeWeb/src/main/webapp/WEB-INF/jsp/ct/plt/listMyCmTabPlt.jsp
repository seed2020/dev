...
function fnTabClick(tId){
	getIframeContent('ctMyTabArea').reload('./listMyCmTabFrm.do?tId='+tId+'&${paramsForList}&hghtPx=${param.hghtPx-tabHght-15}');
};
...
<%-- <c:if test="${tabHght > 0 }">
 ...
 --%>
<iframe id="ctMyTabArea" name="ctMyTabArea" src="./listMyCmTabFrm.do?tId=${tId }&${paramsForList }&hghtPx=${param.hghtPx-tabHght-15}" style="width:100%;height:${param.hghtPx-tabHght-15}px;" frameborder="0" marginheight="0" marginwidth="0"></iframe>
</div>