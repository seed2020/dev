...
<c:set var="bodyList" value="subj"/><!-- 데이터 목록 -->
...
<u:authUrl var="viewUrl" url="/ct/notc/viewNotc.do" authCheckUrl="/ct/notc/listNotc.do" />
				...
				<tr onmouseover='this.className="trover"' onmouseout='this.className="trout"'>
					<c:forTokens	items="${bodyList}" var="colId" varStatus="colStatus" delims=",">
						<td class="body_${colId }" id="list_${colStatus.count == 1 ? colId : '' }" style="display:none;">
							<c:choose>
								<c:when test="${colId eq 'subj' }"><div class="ellipsis" title="<u:convertMap srcId="mapList" attId="${colId}" type="html" />"><a href="javascript:viewBull('${mapList.bullId}');"><u:convertMap srcId="mapList" attId="${colId}" type="html" /></a></div></c:when>
