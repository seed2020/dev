...
function applyoendAnsTooltip() {
	/*
	$('.wv_survOendAnsInfo').mouseover(function(event){
	...
	$('.wv_survOendAnsInfo').mouseout(function(event){
	...
	<form id="listDeptStatForm" action="../listOendAnsFrm.do">
		...
		<div class="listarea">
			<table class="listtable" border="0" cellpadding="0" cellspacing="1" style="width:100%;table-layout:fixed;">
				...
				<c:forEach  var="wvsOend" items="${wvSurvBMapList}"  varStatus="status">
					<tr onmouseover='this.className="trover"' onmouseout='this.className="trout"'>
					<td class="body_ct"><u:out value="${wvsOend.rnum}"/></td>
					<td class="body_lt">
						<div class="ellipsis" title="${wvsOend.oendReplyCont}">
