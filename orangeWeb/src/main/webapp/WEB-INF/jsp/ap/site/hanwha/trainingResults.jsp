...
<u:listArea id="xml-detail" colgroup="15%,35%,15%,35%">
	...
	<tr>
		<td class="head_lt"><u:mandatory /><u:msg title="적용가능성" alt="적용가능성" /></td>
		<td colspan="3"><u:textarea id="erpApplyCont" value="${formBodyXML.getAttr('body/detail.erpApplyCont')}" title="적용가능성" maxByte="3000" style="width:98%;" rows="10" mandatory="Y" /></td>
	</tr>
</u:listArea>
</div>
...
<u:listArea colgroup="15%,35%,15%,35%">
	...
	<tr>
		...
		<td class="body_lt" colspan="3">
			...
			<td>일 /</td>
			<td>${formBodyXML.getAttr('body/detail.erpTotalTime')}</td>
			<td>시간</td>
			<td>)</td>
			</tr>
			</table>
	...
	<tr>
		...
		<td colspan="3"><textarea id="erpCont" style="width:98%;" rows="10" readonly="readonly" title="교육내용" >${formBodyXML.getAttr('body/detail.erpCont')}</textarea></td>
	</tr>
	<tr>
		<td class="head_lt"><u:msg title="적용가능성" alt="적용가능성" /></td>
		<td colspan="3"><textarea id="erpApplyCont" style="width:98%;" rows="10" readonly="readonly" title="적용가능성" >${formBodyXML.getAttr('body/detail.erpApplyCont')}</textarea></td>
	</tr>
</u:listArea>
