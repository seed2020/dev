...
<div id="xml-head">
	<input type="hidden" name="typId" value="lossStatement"/>
...
<u:listArea id="xml-daily" colgroup="13%,37%,13%,37%">
	<tr>
		...
		<td class="head_ct">총합계</td>
		<td class="body_lt"><u:input id="erpValue12" value="${formBodyXML.getAttr('body/daily.erpValue12')}" title="총합계" style="width:95%;" maxByte="100" valueOption="number" commify="Y" /></td>
	</tr>
</u:listArea>
...
<u:listArea id="xml-rows/row" colgroup="12%,12%,12%,12%,12%,12%,12%,*">
	<tr id="headerTr">
		...
		<td class="head_ct">생산수량</td>
		<td class="head_ct">반입수량</td>
		<td class="head_ct">불량수량</td>
		<td class="head_ct">사용수량</td>
		<td class="head_ct">영업단가</td>
		<td class="head_ct">손실금액</td>
		<td class="head_ct">보관수량/비고</td>
	</tr>
	<c:forEach
	...
	<tr id="${status.last ? 'hiddenTr' : 'row'}" style="${status.last ? 'display:none' : ''}">
		<td class="body_ct"><u:input id="erpValue1_${status.index }" name="erpValue1" value="${row.getAttr('erpValue1')}" title="품명" style="width:90%;" maxByte="100" /></td>
		<td class="body_ct"><u:input id="erpValue2_${status.index }" name="erpValue2" value="${row.getAttr('erpValue2')}" title="생산수량" style="width:90%;" maxByte="100" valueOption="number" commify="Y" /></td>
		<td class="body_ct"><u:input id="erpValue3_${status.index }" name="erpValue3" value="${row.getAttr('erpValue3')}" title="반입수량" style="width:90%;" maxByte="100" valueOption="number" commify="Y" /></td>
		<td class="body_ct"><u:input id="erpValue4_${status.index }" name="erpValue4" value="${row.getAttr('erpValue4')}" title="불량수량" style="width:90%;" maxByte="100" valueOption="number" commify="Y" /></td>
		<td class="body_ct"><u:input id="erpValue5_${status.index }" name="erpValue5" value="${row.getAttr('erpValue5')}" title="사용수량" style="width:90%;" maxByte="100" valueOption="number" commify="Y" /></td>
		<td class="body_ct"><u:input id="erpValue6_${status.index }" name="erpValue6" value="${row.getAttr('erpValue6')}" title="영업단가" style="width:90%;" maxByte="100" valueOption="number" commify="Y" /></td>
		<td class="body_ct"><u:input id="erpValue7_${status.index }" name="erpValue7" value="${row.getAttr('erpValue7')}" title="손실금액" style="width:90%;" maxByte="100" valueOption="number" commify="Y" /></td>
		<td class="body_ct"><u:input id="erpValue8_${status.index }" name="erpValue8" value="${row.getAttr('erpValue8')}" title="보관수량/비고" style="width:90%;" maxByte="100" /></td>
	</tr></c:forEach>
</u:listArea>
<u:listArea>
<tr><td class="head_ct">불량세부내역</td></tr>
...
<u:listArea colgroup="13%,37%,13%,37%">
	<tr>
		<td class="head_ct">일자</td>
		<td class="body_lt"><u:out value="${formBodyXML.getAttr('body/daily.erpValue11')}" type="date"/></td>
		<td class="head_ct">총합계</td>
