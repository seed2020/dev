...
<div id="xml-head">
	<input type="hidden" name="typId" value="trainingResults"/>
...
<u:listArea id="xml-detail" colgroup="12%,11%,33%,11%,33%">
	<tr>
		<td class="head_ct" rowspan="3">교육과정</td>
		<td class="head_lt"><u:mandatory /><u:msg title="교육명" alt="교육명" /></td>
		<td><u:input id="erpSubj" value="${formBodyXML.getAttr('body/detail.erpSubj')}" title="교육명" style="width:95%;" maxByte="200" mandatory="Y"/></td>
		<td class="head_lt"><u:mandatory /><u:msg title="교육기관" alt="교육기관" /></td>
		<td><u:input id="erpInstitutions" value="${formBodyXML.getAttr('body/detail.erpInstitutions')}" title="교육기관" style="width:95%;" maxByte="100" mandatory="Y"/></td>
	</tr><tr>
	...
	<tr>
		...
		<td><u:input id="erpPlace" value="${formBodyXML.getAttr('body/detail.erpPlace')}" title="교육장소" style="width:95%;" maxByte="100" mandatory="Y"/></td>
		<td class="head_lt"><u:msg title="교육비(원)" alt="교육비(원)" /></td>
		<td><u:input id="erpTuition" value="${formBodyXML.getAttr('body/detail.erpTuition')}" title="교육비(원)" valueOption="number" maxLength="9" onfocus="uncommifyInput('erpTuition');" onblur="commifyInput('erpTuition');"/></td>		
	</tr>	
</u:listArea>
<u:listArea>
...
<u:listArea colgroup="12%,11%,33%,11%,33%">
	<tr>
		...
		<td class="body_lt">${formBodyXML.getAttr('body/detail.erpSubj')}</td>
