...
<div id="xml-head">
	<input type="hidden" name="typId" value="linkedIssDJ3"/>
...
<div id="xml-body">
<u:title type="small" title="영업부서 작성 (발생후 24시간 내에 작성)" />
...
<tr>
	...
	<td class="body_lt"><u:input id="erpVa1" title="사양" value="${formBodyXML.getAttr('body/accident.erpVa1')}"
		style="width:96%" /></td>
	<td class="head_ct">고 객 명</td>
	<td class="body_lt"><u:input id="erpVa2" title="고객명" value="${formBodyXML.getAttr('body/accident.erpVa2')}"
		style="width:96%" /></td>
</tr>
<tr>
	...
	<td class="body_lt"><u:input id="erpVa3" title="규격" value="${formBodyXML.getAttr('body/accident.erpVa3')}"
		style="width:96%" /></td>
	<td class="head_ct">주 소</td>
	<td class="body_lt"><u:input id="erpVa4" title="주소" value="${formBodyXML.getAttr('body/accident.erpVa4')}"
		style="width:96%" /></td>
</tr>
<tr>
	...
	<td class="body_lt"><u:input id="erpVa5" title="총수량" value="${formBodyXML.getAttr('body/accident.erpVa5')}"
		style="width:96%" /></td>
	<td class="head_ct">접 수 일 자</td>
	<td class="body_lt"><u:calendar id="erpVa6" title="접수일자" value="${formBodyXML.getAttr('body/accident.erpVa6')}" /></td>
</tr>
<tr>
	...
	<td class="body_lt"><u:input id="erpVa7" title="부적합 수량" value="${formBodyXML.getAttr('body/accident.erpVa7')}"
		style="width:96%" /></td>
	<td class="head_ct">처 리 요 구 일자</td>
	<td class="body_lt"><u:calendar id="erpVa8" title="처리요구 일자" value="${formBodyXML.getAttr('body/accident.erpVa8')}" /></td>
</tr>
</u:listArea>
...
<tr>
	...
	<tr><u:checkbox title="시공팀"  value="Y" name="erpCK201" checkValue="${formBodyXML.getAttr('body/accident2.erpCK201')}" />
		<u:checkbox title="건설사" value="Y" name="erpCK202" checkValue="${formBodyXML.getAttr('body/accident2.erpCK202')}" />
		<u:checkbox title="고객" value="Y" name="erpCK203" checkValue="${formBodyXML.getAttr('body/accident2.erpCK203')}" /></tr>
		</table></td>
...
<tr>
	...
	<tr><u:checkbox title="글레이징" value="Y" textColspan="4"
			name="erpCK309" checkValue="${formBodyXML.getAttr('body/accident2.erpCK309')}" />
		<u:checkbox title="출하" value="Y"
			name="erpCK310" checkValue="${formBodyXML.getAttr('body/accident2.erpCK310')}" />
		<u:checkbox title="운반" value="Y"
			name="erpCK311" checkValue="${formBodyXML.getAttr('body/accident2.erpCK311')}" />
		<u:checkbox title="시공" value="Y"
			name="erpCK312" checkValue="${formBodyXML.getAttr('body/accident2.erpCK312')}" /></tr>
		</table></td>
...
<tr>
	<td class="head_ct">소 비 자<br/>불 만 내 용<br/>(사진 첨부)</td>
...
<tr>
	<td class="head_ct">시 정 및<br/>예 방 조 치 요 구</td>
	<td class="body_lt" colspan="3"><table border="0" cellpadding="0" cellspacing="0">
	<tr><u:checkbox title="필요"  value="Y" name="erpCK401" checkValue="${formBodyXML.getAttr('body/accident2.erpCK401')}" />
		<u:checkbox title="불필요" value="Y" name="erpCK402" checkValue="${formBodyXML.getAttr('body/accident2.erpCK402')}" /></tr>
		</table></td>
</tr>
</u:listArea>
...
<tr>
	<td class="head_ct">부 적 합 내 용<br/>발 생 구 분</td>
	<td class="body_lt">
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK201')}"><nobr>시공팀,</nobr></c:if>
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK202')}"><nobr>건설사,</nobr></c:if>
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK203')}"><nobr>고객</nobr></c:if></td>
	<td class="head_ct">발 생 일 자</td>
...
<tr>
	...
	<td class="body_lt">
		...
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK308')}"><nobr>포장,</nobr></c:if>
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK309')}"><nobr>글레이징,</nobr></c:if>
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK310')}"><nobr>출하,</nobr></c:if>
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK311')}"><nobr>운반,</nobr></c:if>
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK312')}"><nobr>시공</nobr></c:if></td>
	<td class="head_ct">발 견 자</td>
...
<tr>
	<td class="head_ct">시 정 및<br/>예 방 조 치 요 구</td>
	<td class="body_lt" colspan="3">
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK401')}"><nobr>필요,</nobr></c:if>
		<c:if test="${not empty formBodyXML.getAttr('body/accident2.erpCK402')}"><nobr>불필요</nobr></c:if></td>
</tr>
</u:listArea>
