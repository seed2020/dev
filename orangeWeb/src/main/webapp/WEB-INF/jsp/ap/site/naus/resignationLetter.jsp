...
<u:listArea id="xml-daily" colgroup="15%," >
	<tr>
		...
		<td class="body_lt"><u:input id="erpValue1" value="${formBodyXML.getAttr('body/daily.erpValue1')}" title="성명" style="width:98%;" maxByte="200" /></td>		
	</tr>
	<tr>
		<td class="head_ct">부서</td>
		<td class="body_lt"><u:input id="erpValue2" value="${formBodyXML.getAttr('body/daily.erpValue2')}" title="부서" style="width:98%;" maxByte="200" /></td>
	</tr>
	<tr>
		<td class="head_ct">입사일</td>
		<td class="body_lt"><u:calendar id="erpValue3" title="입사일" value="${formBodyXML.getAttr('body/daily.erpValue3')}" /></td>		
	</tr>
	<tr>
		<td class="head_ct">사직희망일</td>
		<td class="body_lt"><u:calendar id="erpValue4" title="입사일" value="${formBodyXML.getAttr('body/daily.erpValue4')}" /></td>
	</tr>
	<tr>
		<td class="head_ct">기타</td>
		<td class="body_lt"><u:input id="erpValue5" value="${formBodyXML.getAttr('body/daily.erpValue5')}" title="기타" style="width:98%;" maxByte="400" /></td>
	</tr>
</u:listArea>
<u:listArea>
