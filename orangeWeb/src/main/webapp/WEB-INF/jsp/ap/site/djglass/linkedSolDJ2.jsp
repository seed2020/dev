...
function openLinkedPop(){
	...
	var param = "&xmlTypId=linkedIssDJ2"+(apvNo!='' ? '&apvNo='+apvNo : '')+(erpLinkedApvNo!=null && erpLinkedApvNo!='' ? '&erpLinkedApvNo='+erpLinkedApvNo : '');
	dialog.open('openLinkedDocDialog', '일반 사고 보고서 선택', './listLinkedDocPop.do?menuId=${menuId}&bxId=${param.bxId}${strMnuParam}'+param);
}<%--
XML 작업 validation --%>
...
<div id="xml-head">
	<input type="hidden" name="typId" value="linkedSolDJ2"/>
...
<u:listArea id="xml-result" colgroup="13%,88%">
<tr>
...
<tr>
	...
	<td class="body_lt"><textarea name="erpVa4" rows="4" style="width:98.4%"><u:out
		type="textarea" value="${formBodyXML.getAttr('body/result.erpVa4')}" /></textarea>
	</td>
</tr>
<tr>
	<td class="head_ct">소 속 부 서<br/>본부장 의견</td>
