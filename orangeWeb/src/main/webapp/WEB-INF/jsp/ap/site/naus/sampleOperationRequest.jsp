...
<div id="xml-head">
	<input type="hidden" name="typId" value="sampleOperationRequest"/>
...
<u:listArea id="xml-daily" colgroup="13%,37%,13%,37%">
	<tr>
		<td class="head_ct">내용</td>
		<td class="body_lt"><u:input id="erpValue11" value="${formBodyXML.getAttr('body/daily.erpValue11')}" title="내용" style="width:95%;" maxByte="400" /></td>
		<td class="head_ct">요청시한</td>
		<td class="body_lt"><u:calendartime id="erpValue12" value="${formBodyXML.getAttr('body/daily.erpValue12')}" title="요청시한" /></td>
	</tr>
</u:listArea>
...
<u:listArea id="xml-rows/row" colgroup="12%,12%,12%,12%,12%,12%,12%,*" >
	...
	<tr id="${status.last ? 'hiddenTr' : 'row'}" style="${status.last ? 'display:none' : ''}">
		<td class="body_ct"><u:input id="erpValue1_${status.index }" name="erpValue1" value="${row.getAttr('erpValue1')}" title="구분" style="width:90%;" maxByte="100" /></td>
		<td class="body_ct"><u:input id="erpValue2_${status.index }" name="erpValue2" value="${row.getAttr('erpValue2')}" title="규격" style="width:90%;" maxByte="100" /></td>
		<td class="body_ct"><u:input id="erpValue3_${status.index }" name="erpValue3" value="${row.getAttr('erpValue3')}" title="원지" style="width:90%;" maxByte="100" /></td>
		<td class="body_ct"><u:input id="erpValue4_${status.index }" name="erpValue4" value="${row.getAttr('erpValue4')}" title="인쇄" style="width:90%;" maxByte="100" /></td>
		<td class="body_ct"><u:input id="erpValue5_${status.index }" name="erpValue5" value="${row.getAttr('erpValue5')}" title="포장" style="width:90%;" maxByte="100" /></td>
		<td class="body_ct"><u:input id="erpValue6_${status.index }" name="erpValue6" value="${row.getAttr('erpValue6')}" title="수량" style="width:90%;" maxByte="100" /></td>
		<td class="body_ct"><u:input id="erpValue7_${status.index }" name="erpValue7" value="${row.getAttr('erpValue7')}" title="비고" style="width:90%;" maxByte="100" /></td>
		<td class="body_ct"><u:input id="erpValue8_${status.index }" name="erpValue8" value="${row.getAttr('erpValue8')}" title="기타" style="width:90%;" maxByte="100" /></td>
	</tr></c:forEach>
</u:listArea>
<u:listArea>
<tr><td class="head_ct">내역</td></tr>
