...
function openListFrm(detlViewType){
	if(detlViewType !=null){
		var url = './findBcFrm.do?menuId=${menuId }&fncCal=${param.fncCal}&fncMul=${param.fncMul}&detlViewType='+detlViewType;
...
<div style="width:600px">
	...
	<iframe id="bcListFrm" name="bcListFrm" src="../wc/findBcFrm.do?menuId=${menuId }&fncCal=${param.fncCal}&fncMul=${param.fncMul}&detlViewType=bcList&schBcRegrUid=${param.schBcRegrUid}&pagingYn=${param.pagingYn}&schCat=${param.schCat }&schWord=${param.schWord}" style="width:100%; height:400px;" frameborder="0" marginheight="0" marginwidth="0"></iframe>
	<% // 하단 버튼 %>
	<u:buttonArea>
