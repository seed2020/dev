...
function onChangeFldYn(object, va){
	...
	setDisabled($frm.find("[name='mnuTypCd']"), disable);
	if(disable || $frm.find("[name='mnuTypCd'] option:selected").val() != 'OUT_POP'){
		disable = true;
	}
...
<u:input type="hidden" id="mnuId" value="${ptMnuDVo.mnuId}" /><c:if
...
<u:listArea>
	...
	<tr>
	<td width="18%" class="head_lt"><u:msg titleId="cols.mnuTyp" alt="메뉴구분" /></td>
	<td><select id="mnuTypCd" name="mnuTypCd" onchange="onChangeMnuTyp(this, this.value)" <u:elemTitle titleId="cols.mnuTyp" />>
	...
	<u:secu auth="SYS">
	<tr>
	<td width="18%" class="head_lt"><u:msg titleId="cols.mdRid" alt="모듈참조ID" /></td>
	<td><u:input id="mdRid" value="${ptMnuDVo.mdRid}" titleId="cols.mdRid" maxByte="30" /></td>
	</tr>
	<tr>
	<td width="18%" class="head_lt"><u:msg titleId="cols.mdId" alt="모듈ID" /></td>
	<td><u:input id="mdId" value="${ptMnuDVo.mdId}" titleId="cols.mdId" maxByte="30" /></td>
	</tr>
	</u:secu>
