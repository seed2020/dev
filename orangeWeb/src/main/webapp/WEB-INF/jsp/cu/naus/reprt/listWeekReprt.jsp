...
function delTaskStat() {
	...
	if (arr != null && confirmMsg("cm.cfrm.del")) {<% // 삭제하시겠습니까? %>
		callAjax('./transWeekReprtDelAjx.do?menuId=${menuId}', {statNos:arr}, function(data) {
...
function viewTaskStat(statNo){
	location.href='./viewWeekReprt.do?${paramsForList}&statNo='+statNo;
}
...
<% // 검색영역 %>
<u:searchArea>
	<form name="searchForm" action="./listWeekReprt.do" >
...
<u:button titleId="cm.btn.write" alt="등록" href="./setWeekReprt.do?menuId=${menuId}" auth="W" />
