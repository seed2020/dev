...
%><%@ page isErrorPage="true"%><%
	...
	// 가상의 사용자는 연계된 시스템을 사용할 수 없습니다.
	request.setAttribute("errorCode", "901");
...
<c:if test="${isPage}">
	...
	<div class="container">
		...
		<div style="position:absolute; margin-left: 50%; left:-320px; margin-top:80px; width:800px">
			...
			<div style="padding:20px 0 10px 30px; font:12px 'dotum','arial'; color:#454545;"><b><u:msg titleId="cm.error.msg" /> : </b><u:msg titleId="cm.error.title.901" alt="가상의 사용자는 연계된 시스템을 사용할 수 없습니다." /></div>
