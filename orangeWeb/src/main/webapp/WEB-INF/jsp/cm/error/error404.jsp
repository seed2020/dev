...
%><%@ page isErrorPage="true"%><%
	...
	if(uri!=null){
		if(uri.indexOf("favicon.ico")<0 && !uri.startsWith("/images/upload/")){
			System.out.println("ERROR - 404 : "+uri);
		} else {
			return;
		}
	}
...
<c:if test="${isPage}">
	...
	<div class="container">
		...
		<div style="position:absolute; margin-left: 50%; left:-320px; margin-top:80px; width:800px">
			...
			<div style="padding:20px 0 10px 30px; font:12px 'dotum','arial'; color:#454545;"><b><u:msg titleId="cm.error.msg" /> : </b><u:msg titleId="cm.error.msg.404" alt="페이지를 찾을 수 없습니다." /></div>
