...
<form id="imgUploadForm" name="imgUploadForm" method="post" enctype="multipart/form-data" >
	...
	<u:set test="${!empty stSiteImgDVo}" var="imgPath" value="${_cxPth}${stSiteImgDVo.imgPath}" elseValue="${_cxPth}/images/${_skin}/photo_noimg_180.png" />
	<u:set test="${!empty stSiteImgDVo && stSiteImgDVo.imgWdth <= maxWdth}" var="imgWdth" value="${stSiteImgDVo.imgWdth}" elseValue="${maxWdth}" />
	<u:set test="${!empty stSiteImgDVo && stSiteImgDVo.imgHght <= maxHght}" var="imgHght" value="${stSiteImgDVo.imgHght}" elseValue="${maxHght}" />
	...
	<div class="listarea" style="width:100%;text-align:center;">
		...
		<td class="photo_ct" style="height:180px;">
			<c:if test="${stSiteImgDVo.imgWdth > 800}"	>
				<a href="${_ctx}${stSiteImgDVo.imgPath}" target="viewPhotoWin"><img id="tmpImage" src="${imgPath}" onerror='this.src="${_cxPth}/images/${_skin}/photo_noimg_180.png"' ${imgWdthHgth}></a>
			</c:if>
			<c:if test="${empty stSiteImgDVo || stSiteImgDVo.imgWdth <= 800}">
