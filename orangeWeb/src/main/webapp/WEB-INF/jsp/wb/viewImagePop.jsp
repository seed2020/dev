...
<form id="photoImageForm" method="post" action="./transImageDel.do">
	...
	<div style="width:${dialogWidth};text-align:center;">
		...
		<img alt="<u:msg alt='이미지 보기' titleId='or.jsp.setOrg.viewImageTitle' />" src="${_cxPth}${wbBcImgDVo.imgPath}" width="${wbBcImgDVo.imgWdth}" height="${wbBcImgDVo.imgHght}" oncontextmenu="return false;" />
	</div>
