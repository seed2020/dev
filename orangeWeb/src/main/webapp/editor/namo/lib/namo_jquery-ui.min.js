...
(function(e) {
    "function" == typeof define && define.amd ? define(["jquery"], e) : e(_namoJquery2)
})(function(e) {
    function t(t, s) {
    ...
    e.extend(n.prototype, {
        ...
        _generateHTML: function(e) {
            var t, i, s, n, a, o, r, h, l, u, d, c, p, f, m, g, v, y, b, _, x, w, k, T, D, S, M, C, N, A, P, I, H, z, F, E, O, j, W, L = new Date,
                ...
                _namoJquery$ = this._getMinMaxDate(e, "max"),
                Z = e.drawMonth - V,
                et = e.drawYear;
            if (0 > Z && (Z += 12, et--), _namoJquery$)
                for (t = this._daylightSavingAdjust(new Date(_namoJquery$.getFullYear(), _namoJquery$.getMonth() - K[0] * K[1] + 1, _namoJquery$.getDate())), t = X && X > t ? X : t; this._daylightSavingAdjust(new Date(et, Z, 1)) > t;) Z--, 0 > Z && (Z = 11, et--);
