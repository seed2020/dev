...
/****** Object:  Vo - Date: 2017/02/23 10:39 ******/
/**
* 리소스기본(WL_RESC_B) 테이블 VO 
*/
public class WlRescBVo extends CommonVoImpl {
	
	/** serialVersionUID */
	private static final long serialVersionUID = -7713452379027722422L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.wl.dao.WlRescBDao.selectWlRescB";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.wl.dao.WlRescBDao.insertWlRescB";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.wl.dao.WlRescBDao.updateWlRescB";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.wl.dao.WlRescBDao.deleteWlRescB";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.wl.dao.WlRescBDao.countWlRescB";
		}
		return null;
	}
