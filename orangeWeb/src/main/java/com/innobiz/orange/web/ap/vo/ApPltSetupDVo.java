...
/**
 * 포틀릿설정상세(AP_PLT_SETUP_D) 테이블 VO
 */
public class ApPltSetupDVo extends CommonVoImpl {

	/** serialVersionUID. */
	private static final long serialVersionUID = 3184440600408233469L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApPltSetupDDao.selectApPltSetupD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApPltSetupDDao.insertApPltSetupD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApPltSetupDDao.updateApPltSetupD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApPltSetupDDao.deleteApPltSetupD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApPltSetupDDao.countApPltSetupD";
		}
		return null;
	}
	...
	public void toString(StringBuilder builder, String tab){
		...
		if(bxId!=null) { if(tab!=null) builder.append(tab); builder.append("bxId(함ID-PK):").append(bxId).append('\n'); }
