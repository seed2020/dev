...
/**
 * 사용자비밀번호상세(OR_USER_PW_D) 테이블 VO
 */
public class OrUserPwDVo extends CommonVoImpl {

	/** serialVersionUID. */
	private static final long serialVersionUID = 6751831892095759372L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.or.dao.OrUserPwDDao.selectOrUserPwD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.or.dao.OrUserPwDDao.insertOrUserPwD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.or.dao.OrUserPwDDao.updateOrUserPwD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.or.dao.OrUserPwDDao.deleteOrUserPwD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.or.dao.OrUserPwDDao.countOrUserPwD";
		}
		return null;
	}
	...
	public String toString(){
		...
		builder.append('[').append(this.getClass().getName()).append(":사용자비밀번호상세]\n");
