...
/**
 * 양식텍스트상세(AP_FORM_TXT_D) 테이블 VO
 */
public class ApFormTxtDVo extends CommonVoImpl {

	/** serialVersionUID. */
	private static final long serialVersionUID = 1014209774541012937L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormTxtDDao.selectApFormTxtD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormTxtDDao.insertApFormTxtD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormTxtDDao.updateApFormTxtD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormTxtDDao.deleteApFormTxtD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormTxtDDao.countApFormTxtD";
		}
		return null;
	}
	...
	public String toString(){
		...
		builder.append('[').append(this.getClass().getName()).append(":양식텍스트상세]\n");
