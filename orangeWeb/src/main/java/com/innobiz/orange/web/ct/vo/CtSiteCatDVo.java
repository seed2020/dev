...
/** CT_SITE_CAT_D [커뮤니티 사이트 카테고리 상세] */
public class CtSiteCatDVo extends CommonVoImpl{
	
	/** serialVersionUID */
	private static final long serialVersionUID = 1177354068850124394L;
	...
	public String getCatNmRescId() {
		return catNmRescId;
	}

	public void setCatNmRescId(String catNmRescId) {
		this.catNmRescId = catNmRescId;
	}
	...
	public void toString(StringBuilder builder, String tab){
		...
		if(catNmRescId!=null) { if(tab!=null) builder.append(tab); builder.append("catNmRescId(카테고리명 리소스 ID):").append(catNmRescId).append('\n'); }
