...
/**
 * 양식결재라인상세(AP_FORM_APV_LN_D) 테이블 VO
 */
public class ApFormApvLnDVo extends CommonVoImpl {

	/** serialVersionUID. */
	private static final long serialVersionUID = 736179245607218720L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormApvLnDDao.selectApFormApvLnD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormApvLnDDao.insertApFormApvLnD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormApvLnDDao.updateApFormApvLnD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormApvLnDDao.deleteApFormApvLnD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormApvLnDDao.countApFormApvLnD";
		}
		return null;
	}
	...
	public String toString(){
		...
		builder.append('[').append(this.getClass().getName()).append(":양식결재라인상세]\n");
