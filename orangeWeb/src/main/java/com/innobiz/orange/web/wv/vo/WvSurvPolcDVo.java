...
/** WV_SURV_POLC_D[설문 정책 상세] */
public class WvSurvPolcDVo extends CommonVoImpl{
	
	/** serialVersionUID */
	private static final long serialVersionUID = -4771801242242621830L;
	...
	public String toString(){
		...
		builder.append('[').append(this.getClass().getName()).append(":설문 정책 상세]\n");
	...
	public void toString(StringBuilder builder, String tab){
		...
		if(regrUid!=null) { if(tab!=null) builder.append(tab); builder.append("regrUid(등록자ID):").append(regrUid).append('\n'); }
		if(modrUid!=null) { if(tab!=null) builder.append(tab); builder.append("modrUid(수정자ID):").append(modrUid).append('\n'); }
