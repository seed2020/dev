...
/** WV_SURV_REPLY_D[설문 답변 상세] */
public class WvSurvReplyDVo extends CommonVoImpl implements Cloneable{

	/** serialVersionUID */
	private static final long serialVersionUID = 4393924227508278894L;
	...
	/** 답변자 부서 ID */
	private String replyrDeptNm;


	public String getReplyrDeptNm() {
		return replyrDeptNm;
	}

	public void setReplyrDeptNm(String replyrDeptNm) {
		this.replyrDeptNm = replyrDeptNm;
	}	
	...
	public Object clone() throws CloneNotSupportedException {
		 WvSurvReplyDVo a = (WvSurvReplyDVo)super.clone();
		  return a;
	...
	/** 질문보기List */
	public List<WvQuesExamDVo> quesExam;
	
	public List<WvQuesExamDVo> getQuesExam() {
		return quesExam;
	}

	public void setQuesExam(List<WvQuesExamDVo> quesExam) {
	...
	public String toString(){
		...
		builder.append('[').append(this.getClass().getName()).append(":설문 답변 상세]\n");
	...
	public void toString(StringBuilder builder, String tab){
		...
		if(replyNo!=0) { if(tab!=null) builder.append(tab); builder.append("replyNo(답변번호):").append(replyNo).append('\n'); }
		...
		if(replyrDeptNm!=null) { if(tab!=null) builder.append(tab); builder.append("replyrDeptNm(답변자 부서 ID):").append(replyrDeptNm).append('\n'); }
