...
/****** Object:  Vo - Date: 2017/05/04 14:47 ******/
/**
* 첨부파일상세(WH_REQ_FILE_D) 테이블 VO 
*/
public class WhReqFileDVo extends CommonVoImpl implements CommonFileVo {
	
	/** serialVersionUID */
	private static final long serialVersionUID = -306779535728856617L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.wh.dao.WhReqFileDDao.selectWhReqFileD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.wh.dao.WhReqFileDDao.insertWhReqFileD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.wh.dao.WhReqFileDDao.updateWhReqFileD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.wh.dao.WhReqFileDDao.deleteWhReqFileD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.wh.dao.WhReqFileDDao.countWhReqFileD";
		}
		return null;
	}
