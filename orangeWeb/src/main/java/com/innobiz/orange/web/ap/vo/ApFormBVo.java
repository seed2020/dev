...
/**
 * 양식기본(AP_FORM_B) 테이블 VO
 */
public class ApFormBVo extends CommonVoImpl {

	/** serialVersionUID. */
	private static final long serialVersionUID = 2670388329646394328L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormBDao.selectApFormB";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormBDao.insertApFormB";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormBDao.updateApFormB";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormBDao.deleteApFormB";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApFormBDao.countApFormB";
		}
		return null;
	}
