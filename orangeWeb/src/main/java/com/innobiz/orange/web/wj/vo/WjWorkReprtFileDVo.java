...
/**
* 첨부파일상세(WJ_WORK_REPRT_FILE_D) 테이블 VO 
*/
public class WjWorkReprtFileDVo extends CommonVoImpl implements CommonFileVo {
	
	/** serialVersionUID */
	private static final long serialVersionUID = -1774621576653349125L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.wj.dao.WjWorkReprtFileDDao.selectWjWorkReprtFileD";
		}else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.wj.dao.WjWorkReprtFileDDao.insertWjWorkReprtFileD";
		}else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.wj.dao.WjWorkReprtFileDDao.updateWjWorkReprtFileD";
		}else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.wj.dao.WjWorkReprtFileDDao.deleteWjWorkReprtFileD";
		}else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.wj.dao.WjWorkReprtFileDDao.countWjWorkReprtFileD";
		}
		return null;
	}
