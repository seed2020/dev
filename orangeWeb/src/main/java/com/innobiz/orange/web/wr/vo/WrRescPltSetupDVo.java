...
/**
 * 포틀릿설정상세(WR_RESC_PLT_SETUP_D) 테이블 VO
 */
public class WrRescPltSetupDVo extends CommonVoImpl {

	/** serialVersionUID */
	private static final long serialVersionUID = 6112204609901551710L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.wr.dao.WrRescPltSetupDDao.selectWrRescPltSetupD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.wr.dao.WrRescPltSetupDDao.insertWrRescPltSetupD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.wr.dao.WrRescPltSetupDDao.updateWrRescPltSetupD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.wr.dao.WrRescPltSetupDDao.deleteWrRescPltSetupD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.wr.dao.WrRescPltSetupDDao.countWrRescPltSetupD";
		}
		return null;
	}
