...
/**
 * 포틀릿설정상세(WB_BC_PLT_SETUP_D) 테이블 VO
 */
public class WbBcPltSetupDVo extends CommonVoImpl {

	/** serialVersionUID */
	private static final long serialVersionUID = 1055017065414966781L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.wb.dao.WbBcPltSetupDDao.selectWbBcPltSetupD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.wb.dao.WbBcPltSetupDDao.insertWbBcPltSetupD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.wb.dao.WbBcPltSetupDDao.updateWbBcPltSetupD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.wb.dao.WbBcPltSetupDDao.deleteWbBcPltSetupD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.wb.daoWbBcPltSetupDDao.countWbBcPltSetupD";
		}
		return null;
	}
