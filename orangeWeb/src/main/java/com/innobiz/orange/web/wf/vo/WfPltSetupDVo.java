...
/****** Object:  Vo - Date: 2018/05/24 17:38 ******/
/**
* 포틀릿설정상세(WF_PLT_SETUP_D) 테이블 VO 
*/
public class WfPltSetupDVo extends CommonVoImpl {
	
	/** serialVersionUID */
	private static final long serialVersionUID = 7549355682990412370L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.wf.dao.WfPltSetupDDao.selectWfPltSetupD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.wf.dao.WfPltSetupDDao.insertWfPltSetupD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.wf.dao.WfPltSetupDDao.updateWfPltSetupD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.wf.dao.WfPltSetupDDao.deleteWfPltSetupD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.wf.dao.WfPltSetupDDao.countWfPltSetupD";
		}
		return null;
	}
