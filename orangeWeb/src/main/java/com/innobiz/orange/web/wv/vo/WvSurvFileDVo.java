...
/** WV_SURV_FILE_D [설문 파일 상세] */
public class WvSurvFileDVo extends CommonVoImpl implements CommonFileVo {
	
	/** serialVersionUID */
	private static final long serialVersionUID = 1124072985322894595L;
	...
	public String toString(){
		...
		builder.append('[').append(this.getClass().getName()).append(":설문 파일 상세]\n");
	...
	public void toString(StringBuilder builder, String tab){
		...
		if(imgUrl!=null) { if(tab!=null) builder.append(tab); builder.append("imgUrl(사용여부):").append(imgUrl).append('\n'); }
