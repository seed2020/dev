...
public class DmFileDVo extends DmCmmBVo implements CommonFileVo {
 	/** 파일ID */ 
	...
	/** 생성자 */ 
	public DmFileDVo(String storId) {
		super(storId);
	}
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.dm.dao.DmFileDDao.selectDmFileD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.dm.dao.DmFileDDao.insertDmFileD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.dm.dao.DmFileDDao.updateDmFileD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.dm.dao.DmFileDDao.deleteDmFileD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.dm.dao.DmFileDDao.countDmFileD";
		}
		return null;
	}
