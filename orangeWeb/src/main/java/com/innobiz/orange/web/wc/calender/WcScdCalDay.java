...
public class WcScdCalDay  extends CommonVoImpl {	
	...
	private List<WcSchdlBVo> scds=new ArrayList<WcSchdlBVo>();
	...
	public List<WcSchdlBVo> getScds() {
		return scds;
	}
	public void setScds(List<WcSchdlBVo> scds) {
		this.scds = scds;
	}
