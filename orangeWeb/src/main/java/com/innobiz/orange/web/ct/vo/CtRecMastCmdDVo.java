...
/** CT_REC_MAST_CMD_D [커뮤니티 자료실 마스터 한줄답변 기본] */
public class CtRecMastCmdDVo extends CommonVoImpl{
	
	/** serialVersionUID */
	private static final long serialVersionUID = 1043094788397342157L;
