...
public class StSitePltSetupDVo extends CommonVoImpl {
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.st.dao.StSitePltSetupDDao.selectStSitePltSetupD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.st.dao.StSitePltSetupDDao.insertStSitePltSetupD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.st.dao.StSitePltSetupDDao.updateStSitePltSetupD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.st.dao.StSitePltSetupDDao.deleteStSitePltSetupD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.st.dao.StSitePltSetupDDao.countStSitePltSetupD";
		}
		return null;
	}
