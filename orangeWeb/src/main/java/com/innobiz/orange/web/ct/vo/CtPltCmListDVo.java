...
/**
 * 포틀릿설정상세(CT_PLT_CM_LIST_D) 테이블 VO
 */
public class CtPltCmListDVo extends CommonVoImpl {

	/** serialVersionUID */
	private static final long serialVersionUID = -7663633996962018298L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltCmListDDao.selectCtPltCmListD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltCmListDDao.insertCtPltCmListD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltCmListDDao.updateCtPltCmListD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltCmListDDao.deleteCtPltCmListD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltCmListDDao.countCtPltCmListD";
		}
		return null;
	}
