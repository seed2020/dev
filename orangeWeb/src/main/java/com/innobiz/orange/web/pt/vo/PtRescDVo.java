...
/**
 * 리소스상세(PT_RESC_D) 테이블 VO
 */
public class PtRescDVo extends CommonVoImpl {

	/** serialVersionUID. */
	private static final long serialVersionUID = 1325532421079868931L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.pt.dao.PtRescDDao.selectPtRescD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.pt.dao.PtRescDDao.insertPtRescD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.pt.dao.PtRescDDao.updatePtRescD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.pt.dao.PtRescDDao.deletePtRescD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.pt.dao.PtRescDDao.countPtRescD";
		}
		return null;
	}
