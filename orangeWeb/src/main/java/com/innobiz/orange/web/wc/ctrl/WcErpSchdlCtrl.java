...
/** ERP 일정 */
@Controller
public class WcErpSchdlCtrl {
	
	/** Logger */
	private static final Logger LOGGER = Logger.getLogger(WcErpSchdlCtrl.class);
	...
	public String listCalendar(HttpServletRequest request,
		...
		return LayoutUtil.getJspPath("/wc/pub/listCalendar");
	}
    ...
    /** [AJAX] 일정 조회 */
	@RequestMapping(value = {"/wc/pub/listSchdlAjx", "/wc/plt/listSchdlAjx"})
	...
	@RequestMapping(value = "/wc/pub/setSchdlPop")
	public String setSchdlPop(HttpServletRequest request,
		...
		return LayoutUtil.getJspPath("/wc/pub/setSchdlPop");
	}
	
	/** 일정 등록, 수정*/
	@RequestMapping(value = "/wc/pub/transSchdl")
	public String transSchdl(HttpServletRequest request,
		...
		try {
			...
			model.put("todo", "parent.reloadCalendar();");
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
