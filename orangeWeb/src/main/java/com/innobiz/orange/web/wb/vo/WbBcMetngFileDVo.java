...
/**
 * 미팅 첨부파일(WB_BC_METNG_FILE_D) 테이블 VO
 */
public class WbBcMetngFileDVo extends CommonVoImpl implements CommonFileVo {
	...
	public String getQueryId(QueryType queryType) {
		...
		if (QueryType.SELECT == queryType) {
			return "com.innobiz.orange.web.wb.dao.WbBcMetngFileDDao.selectWbBcMetngFileD";
		} else if (QueryType.INSERT == queryType) {
			return "com.innobiz.orange.web.wb.dao.WbBcMetngFileDDao.insertWbBcMetngFileD";
		} else if (QueryType.UPDATE == queryType) {
			return "com.innobiz.orange.web.wb.dao.WbBcMetngFileDDao.updateWbBcMetngFileD";
		} else if (QueryType.DELETE == queryType) {
			return "com.innobiz.orange.web.wb.dao.WbBcMetngFileDDao.deleteWbBcMetngFileD";
		} else if (QueryType.COUNT == queryType) {
			return "com.innobiz.orange.web.wb.dao.WbBcMetngFileDDao.countWbBcMetngFileD";
		}
		return null;
	}
	...
	public String toString() {
		...
		sb.append('[').append(this.getClass().getName()).append(":미팅 첨부파일]\n");
		toString(sb, null);
		return sb.toString();
	}
