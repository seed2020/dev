...
/**
 * 포틀릿설정상세(BA_PLT_SETUP_D) 테이블 VO
 */
public class BaPltSetupDVo extends CommonVoImpl {

	/** serialVersionUID */
	private static final long serialVersionUID = -3906604314710031297L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.bb.dao.BaPltSetupDDao.selectBaPltSetupD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.bb.dao.BaPltSetupDDao.insertBaPltSetupD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.bb.dao.BaPltSetupDDao.updateBaPltSetupD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.bb.dao.BaPltSetupDDao.deleteBaPltSetupD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.bb.dao.BaPltSetupDDao.countBaPltSetupD";
		}
		return null;
	}
