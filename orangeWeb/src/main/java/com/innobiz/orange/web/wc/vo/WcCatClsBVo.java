...
public class WcCatClsBVo extends CommonVoImpl {
	/** 카테고리ID */ 
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.wc.dao.WcCatClsBDao.selectWcCatClsB";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.wc.dao.WcCatClsBDao.insertWcCatClsB";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.wc.dao.WcCatClsBDao.updateWcCatClsB";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.wc.dao.WcCatClsBDao.deleteWcCatClsB";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.wc.dao.WcCatClsBDao.countWcCatClsB";
		}
		return null;
	}
