...
/**
 * 포틀릿설정상세(ST_SITE_PLT_SETUP_D) 테이블 VO
 */
public class CuNotePltSetupDVo extends CommonVoImpl {

	/** serialVersionUID */
	private static final long serialVersionUID = -1225515482991848158L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.wh.dao.WhPltSetupDDao.selectWhPltSetupD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.wh.dao.WhPltSetupDDao.insertWhPltSetupD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.wh.dao.WhPltSetupDDao.updateWhPltSetupD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.wh.dao.WhPltSetupDDao.deleteWhPltSetupD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.wh.dao.WhPltSetupDDao.countWhPltSetupD";
		}
		return null;
	}
