...
public class CtBullMastBVo extends CommonVoImpl{

	/** serialVersionUID */
	private static final long serialVersionUID = 2983425558510126378L;
	...
	public void toString(StringBuilder builder, String tab){
		...
		if(replyOrdr!=0) { if(tab!=null) builder.append(tab); builder.append("replyOrdr(답변순서):").append(replyOrdr).append('\n'); }
		if(replyDpth!=0) { if(tab!=null) builder.append(tab); builder.append("replyDpth(답변단계):").append(replyDpth).append('\n'); }
		...
		if(scre!=null) { if(tab!=null) builder.append(tab); builder.append("scre(점수):").append(scre).append('\n'); }
