...
/**
 * 진행양식항목내역(AP_ONGO_FORM_ITEM_L) 테이블 VO
 */
public class ApOngoFormItemLVo extends CommonVoImpl {

	/** serialVersionUID. */
	private static final long serialVersionUID = 948142045847223221L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApOngoFormItemLDao.selectApOngoFormItemL";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApOngoFormItemLDao.insertApOngoFormItemL";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApOngoFormItemLDao.updateApOngoFormItemL";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.ap.dao.ApOngoFormItemLDao.deleteApOngoFormItemL";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.ap.dao.ApOngoFormItemLDao.countApOngoFormItemL";
		}
		return null;
	}
	...
	public String toString(){
		...
		builder.append('[').append(this.getClass().getName()).append(":진행양식항목내역]\n");
