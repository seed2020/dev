...
/**
 * 포틀릿설정상세(CT_PLT_NOPR_LIST_D) 테이블 VO
 */
public class CtPltNoPrListDVo extends CommonVoImpl {

	/** serialVersionUID */
	private static final long serialVersionUID = 2434727279112422817L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltNoPrListDDao.selectCtPltNoPrListD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltNoPrListDDao.insertCtPltNoPrListD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltNoPrListDDao.updateCtPltNoPrListD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltNoPrListDDao.deleteCtPltNoPrListD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.ct.dao.CtPltNoPrListDDao.countCtPltNoPrListD";
		}
		return null;
	}
