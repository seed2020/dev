...
/**
* 리소스기본(ST_RESC_B) 테이블 VO 
*/
@SuppressWarnings("serial")
public class StRescBVo extends CommonVoImpl {
	/** 리소스ID */ 
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.st.dao.StRescBDao.selectStRescB";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.st.dao.StRescBDao.insertStRescB";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.st.dao.StRescBDao.updateStRescB";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.st.dao.StRescBDao.deleteStRescB";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.st.dao.StRescBDao.countStRescB";
		}
		return null;
	}
