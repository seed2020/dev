...
/** CT_PR_B [커뮤니티 홍보마당 게시물 기본] */
public class CtPrBVo extends CommonVoImpl{
	
	/** serialVersionUID */
	private static final long serialVersionUID = -1443472041745465467L;
	...
	public String getCtSubjRescId() {
		return ctSubjRescId;
	}

	public void setCtSubjRescId(String ctSubjRescId) {
		this.ctSubjRescId = ctSubjRescId;
	}
	...
	public void toString(StringBuilder builder, String tab){
		...
		if(ctSubjRescId!=null) { if(tab!=null) builder.append(tab); builder.append("ctSubjRescId(커뮤니티 제목 리소스 ID):").append(ctSubjRescId).append('\n'); }
