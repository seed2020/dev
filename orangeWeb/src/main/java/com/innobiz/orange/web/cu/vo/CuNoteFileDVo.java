...
/**
* 첨부파일상세(CU_NOTE_FILE_D) 테이블 VO 
*/
public class CuNoteFileDVo extends CommonVoImpl implements CommonFileVo {
	
	/** serialVersionUID */
	private static final long serialVersionUID = -7001841491182497417L;
	...
	public String getQueryId(QueryType queryType) {
		...
		if(QueryType.SELECT==queryType){
			return "com.innobiz.orange.web.cu.dao.CuNoteRecvBDao.selectCuNoteFileD";
		} else if(QueryType.INSERT==queryType){
			return "com.innobiz.orange.web.cu.dao.CuNoteRecvBDao.insertCuNoteFileD";
		} else if(QueryType.UPDATE==queryType){
			return "com.innobiz.orange.web.cu.dao.CuNoteRecvBDao.updateCuNoteFileD";
		} else if(QueryType.DELETE==queryType){
			return "com.innobiz.orange.web.cu.dao.CuNoteRecvBDao.deleteCuNoteFileD";
		} else if(QueryType.COUNT==queryType){
			return "com.innobiz.orange.web.cu.dao.CuNoteRecvBDao.countCuNoteFileD";
		}
		return null;
	}
