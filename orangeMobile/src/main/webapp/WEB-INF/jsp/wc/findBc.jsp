...
//<![CDATA[
var searchParam = {selection:'${param.selection}', schCat:'bcNm',schWord:'${param.schWord}',detlViewType:'${empty param.detlViewType ? "bcList" : param.detlViewType}', schBcRegrUid:'${param.schBcRegrUid}'};
...
function searchBc(param){
	$m.ajax('/wc/findBcAjx.do?menuId=${param.menuId}&fncCal=${param.fncCal}', param, function(html){
...
function goAjaxPage(pageNo){
	$m.ajax('${_cxPth}/wc/findBcAjx.do?menuId=${param.menuId}&fncCal=${param.fncCal}&pageNo='+pageNo, new ParamMap(searchParam), function(html){
		bcListArea.html(html);
	}, {mode:'HTML', async:true});
}
//]]>
