...
function searchBc(param){
	$m.ajax('/ct/schdl/findBcAjx.do?menuId=${param.menuId}&ctId=${param.ctId}', param, function(html){
...
function goAjaxPage(pageNo){
	$m.ajax('/ct/schdl/findBcAjx.do?menuId=${param.menuId}&ctId=${param.ctId}&pageNo='+pageNo, new ParamMap(searchParam), function(html){
		bcListArea.html(html);
	}, {mode:'HTML', async:true});
}
//]]>
